                ...
                <?php reactor_inner_content_before(); ?>
        			...
        			<div class="row">
                      <div id="contact-form" class="<?php reactor_columns( 12 ) ?> entry-content">
                        ...
                        <?php } ?>
                        <?php if ( !isset( $hasError ) ){ $nameError = ''; $emailError = ''; $commentError = ''; $errorClass = ''; } ?>
                        <form action="<?php the_permalink(); ?>" id="contactForm" method="post" class="nice">
                          <div class="contact-form row">
                            <div class="<?php reactor_columns( 7 ) ?>">
                              <label class="<?php echo $errorClass;?>" for="contactName">Name:</label>
                              <input type="text" name="contactName" id="contactName" value="<?php if ( isset( $_POST['contactName'] ) ) echo $_POST['contactName'];?>" class="required <?php echo $errorClass;?>" />
                              <?php if ( $nameError != '') : ?>
                            ...
                            <div class="<?php reactor_columns( 12 ) ?>">
                              <input type="submit" value="<?php echo apply_filters('reactor_contactform_submit', 'Send'); ?>" class="button" />
                            </div>
                          </div>
