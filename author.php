	...
	<div id="primary" class="site-content">
        ...
        <div id="content" role="main">
        	<div class="row">
                ...
                t<img style="padding-bottom: 25px;" src="/wp/wp-content/themes/itacare/img/blog_head.jpg" />
				...
				<?php if ( have_posts() ) : the_post(); ?>
                    ...
                    <header class="archive-header">
                        <h1 class="archive-title"><?php printf( __('Autor: %s', 'reactor'), get_the_author() ); ?></h1>
                    ...
                    <div class="author-info">
                        ...
                        <div class="author-description">
                            <h2><?php printf( __('Sobre %s', 'reactor'), get_the_author() ); ?></h2>
