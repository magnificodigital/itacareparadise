...
if ( !function_exists('reactor_customize_register') ) {
	...
	function reactor_customize_register( $wp_customize ) {
		...
		if ( in_array( '1c', $layouts[0] ) ) {   $theme_layouts['1c']   = __('Uma coluna', 'reactor'); }
		if ( in_array( '2c-l', $layouts[0] ) ) { $theme_layouts['2c-l'] = __('Barra Lateral', 'reactor'); }
		//if ( in_array( '2c-r', $layouts[0] ) ) { $theme_layouts['2c-r'] = __('Duas Colunas, Direita', 'reactor'); }
        
		// if ( in_array( '3c-l', $layouts[0] ) ) { $theme_layouts['3c-l'] = __('Três Colunas, Esquerda', 'reactor'); }
		// if ( in_array( '3c-r', $layouts[0] ) ) { $theme_layouts['3c-r'] = __('Three Columns, Direita', 'reactor'); }
		// if ( in_array( '3c-c', $layouts[0] ) ) { $theme_layouts['3c-c'] = __('Three Columns, Centro', 'reactor'); }
