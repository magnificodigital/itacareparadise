...
function reactor_register_menus() {
    ...
    */
	...
	if ( in_array( 'main-menu', $menus[0] ) ) {
		register_nav_menu('main-menu', __( 'Menu Principal', 'reactor'));
	}
	
	if ( in_array( 'side-menu', $menus[0] ) ) {
		register_nav_menu('side-menu', __( 'Menu Lateral', 'reactor'));
	}
	
	if ( in_array( 'footer-links', $menus[0] ) ) {
		register_nav_menu('footer-links', __( 'Links do Footer', 'reactor'));
	}
    
    if ( in_array( 'footer-blog', $menus[0] ) ) {
        register_nav_menu('footer-blog', __( 'Categorias do Blog', 'reactor'));
    }
