...
function reactor_register_post_types() { 
	...
	if ( in_array('slides', $post_types[0] ) ) {
		function reactor_slide_register() {
			...
			$labels = array( 
				...
				'add_new'            => __('Adicionar Novo', 'reactor'),
				'add_new_item'       => __('Adicionar Novo Slide', 'reactor'),
				'edit_item'          => __('Editar Slide', 'reactor'),
				'new_item'           => __('Novo Slide', 'reactor'),
				'all_items'          => __('Todos os Slides', 'reactor'),
				'view_item'          => __('Ver Slide', 'reactor'),
				'search_items'       => __('Procurar Slides', 'reactor'),
				'not_found'          => __('Nada encontrado', 'reactor'),
				'not_found_in_trash' => __('Nadas encontrado na Lixeira', 'reactor'),
				'parent_item_colon'  => '',
    ...
    if ( in_array('vantagens', $post_types[0] ) ) {
        function reactor_vantagens_register() {
                
            $labels = array( 
                'name'               => __('Vantagens', 'reactor'),
                'singular_name'      => __('Vantagem', 'reactor'),
                'add_new'            => __('Adicionar Nova', 'reactor'),
                'add_new_item'       => __('Adicionar Nova Vantagem', 'reactor'),
                'edit_item'          => __('Editar Vantagem', 'reactor'),
                'new_item'           => __('Nova Vantagem', 'reactor'),
                'all_items'          => __('Todas as Vantagens', 'reactor'),
                'view_item'          => __('Ver Vantagem', 'reactor'),
                'search_items'       => __('Procurar Vantagem', 'reactor'),
                'not_found'          => __('Nada encontrado', 'reactor'),
                'not_found_in_trash' => __('Nadas encontrado na Lixeira', 'reactor'),
                'parent_item_colon'  => '',
                'menu_name'          => __('Vantagens', 'reactor')
             );
        ...
        add_action('init', 'reactor_vantagens_register');
        
    }
    
    if ( in_array('depoimentos', $post_types[0] ) ) {
        function reactor_depoimentos_register() {
                
            $labels = array( 
                'name'               => __('Depoimentos', 'reactor'),
                'singular_name'      => __('Depoimento', 'reactor'),
                'add_new'            => __('Adicionar Novo', 'reactor'),
                'add_new_item'       => __('Adicionar Novo Depoimento', 'reactor'),
                'edit_item'          => __('Editar Depoimento', 'reactor'),
                'new_item'           => __('Novo Depoimento', 'reactor'),
                'all_items'          => __('Todas os Depoimentos', 'reactor'),
                'view_item'          => __('Ver Depoimento', 'reactor'),
                'search_items'       => __('Procurar Depoimento', 'reactor'),
                'not_found'          => __('Nada encontrado', 'reactor'),
                'not_found_in_trash' => __('Nadas encontrado na Lixeira', 'reactor'),
                'parent_item_colon'  => '',
                'menu_name'          => __('Depoimentos', 'reactor')
             );
        ...
        add_action('init', 'reactor_depoimentos_register');
		...
		function reactor_slide_taxonomies() {
		  ...
		  $labels = array( 
			...
			'menu_name'         => __('Categorias', 'reactor'),
		  ); 	
